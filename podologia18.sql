...
CREATE TABLE `inventario_codigos_barras` (
  ...
  `fecha_creacion` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_codigo_barra_por_producto` (`inventario_id`,`codigo_barra`),
...
CREATE TABLE `usuarios` (
  ...
  `fecha_creacion` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_usuarios_correo_por_clinica` (`clinica_id`,`correo`),
...
-- Dump completed on 2026-05-19 16:51:23
