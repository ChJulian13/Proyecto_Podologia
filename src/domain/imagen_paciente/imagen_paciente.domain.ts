...
export const CreateImagenSchema = z.object({
  ...
  // Puede estar ligada a una consulta específica o solo al paciente general
  consulta_id: z.string().uuid("El ID de la consulta debe ser un UUID válido").optional().nullable(),
